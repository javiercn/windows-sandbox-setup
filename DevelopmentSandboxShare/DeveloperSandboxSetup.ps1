...
Start-Process "C:\Program Files\PowerShell\6\pwsh.exe" -ArgumentList "-noexit", "-c", "Write-Host $using:initialText" -WorkingDirectory (Resolve-Path "$env:USERPROFILE\source\repos\3.1*");
pwsh.exe